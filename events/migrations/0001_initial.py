    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_users', models.ManyToManyField(blank=True, related_name='events_targeted', to=settings.AUTH_USER_MODEL)),
                ('media_attachments', models.ManyToManyField(blank=True, to='events.eventattachment')),
                ('tags', models.ManyToManyField(blank=True, to='events.eventtag')),
                ('recurring_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='events.recurringeventrule')),
            ],
        ),
        migrations.CreateModel(
