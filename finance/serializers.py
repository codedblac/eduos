...
from .models import (
    ...
    StudentInvoice, RecurringTransaction, JournalEntry,
    AuditTrail, StudentInvoice
)
...
class InvoiceItemSerializer(serializers.ModelSerializer):
    fee_item_name = serializers.StringRelatedField(source="fee_item", read_only=True)
...
class StudentInvoiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StudentInvoice
        fields = "__all__"
        read_only_fields = ['created_at', 'status', 'balance', 'created_by']
...
class JournalEntrySerializer(serializers.ModelSerializer):
    posted_by_name = serializers.StringRelatedField(source="posted_by", read_only=True)
