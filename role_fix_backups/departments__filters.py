...
class DepartmentFilter(filters.FilterSet):
    ...
    class Meta:
        model = Department
        fields = [ 'institution', 'type', 'is_academic', 'parent_department', 'is_deleted']
...
class DepartmentUserFilter(filters.FilterSet):
    ...
    primary_role= filters.ChoiceFilter(choices=DepartmentUser.ROLE_CHOICES)
    is_active = filters.BooleanFilter()

    class Meta:
        model = DepartmentUser
        fields = ['user', 'department', 'primary_role', 'is_active']
...
class DepartmentRoleAssignmentHistoryFilter(filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['user', 'department', 'primary_role', 'assigned_on__gte', 'revoked_on__isnull']
...
class SubjectFilter(filters.FilterSet):
    ...
    class Meta:
        model = Subject
        fields = [ 'department', 'assigned_teacher', 'is_examable', 'is_mapped_to_timetable', 'is_linked_to_elearning']
