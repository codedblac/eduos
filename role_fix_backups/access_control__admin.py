...
class RolePermissionAdmin(admin.ModelAdmin):
    list_display = ['primary_role', 'permission', 'allow']
    list_filter = ['allow', 'primary_role', 'permission']
...
class UserRoleAssignmentAdmin(admin.ModelAdmin):
    list_display = ['user', 'primary_role', 'institution', 'is_active', 'assigned_at', 'expires_at']
    list_filter = ['is_active', 'institution', 'primary_role']
...
class RoleAuditLogAdmin(admin.ModelAdmin):
    list_display = ['actor', 'target_user', 'primary_role', 'institution', 'action', 'timestamp']
