...
class IsLibrarian(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        return hasattr(request.user, 'role') and request.user.primary_role== CustomUser.LIBRARIAN
...
class IsStudent(permissions.BasePermission):
    ...
    """
    def has_permission(self, request, view):
        return hasattr(request.user, 'role') and request.user.primary_role== CustomUser.STUDENT
...
class IsTeacher(permissions.BasePermission):
    ...
    """
    def has_permission(self, request, view):
        return hasattr(request.user, 'role') and request.user.primary_role== CustomUser.TEACHER
...
class IsAdminOrLibrarian(permissions.BasePermission):
    ...
    """
    def has_permission(self, request, view):
        return hasattr(request.user, 'role') and request.user.primary_role in [
